...
typedef struct {
    ...
    struct {
        ...
        void (* send_tm_1_4_error_in_acceptance)(const __termina_event_t * const,
                                                 ...
                                                 uint16_t,
                                                 __status_int32_t * const);
        void (* send_tm_1_4_mem_address_not_valid)(const __termina_event_t * const,
                                                   void * const, uint16_t,
                                                   uint16_t, uint8_t, uint32_t,
                                                   __status_int32_t * const);
        void (* send_tm_1_4_mem_id_read_only)(const __termina_event_t * const,
        ...
        void (* send_tm_1_4_short_pack_length)(const __termina_event_t * const,
                                               ...
                                               size_t,
                                               __status_int32_t * const);
        void (* send_tm_1_8_mem_access_error)(const __termina_event_t * const,
                                              void * const, uint16_t, uint16_t,
                                              uint8_t,
                                              __status_int32_t * const);
