...
typedef struct {
    ...
    struct {
        ...
        void (* send_tm_1_4_mem_address_not_valid)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint8_t mem_id, uint32_t mem_address, Status__i32 * const status);
        void (* send_tm_1_4_mem_id_read_only)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint8_t mem_id, Status__i32 * const status);
        ...
        void (* send_tm_1_8_mem_access_error)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint8_t mem_ID, Status__i32 * const status);
