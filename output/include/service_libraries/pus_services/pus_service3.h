...
typedef struct {
    ...
    struct {
        ...
        void (* send_tm_1_4_SID_not_valid)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t SID, Status__i32 * const status);
