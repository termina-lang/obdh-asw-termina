...
typedef struct {
    ...
    struct {
        void * __that;
        void (* send_tm_5_2)(const __termina_event_t * const __ev, void * const __this, __status_int32_t * const status);
    } pus_service_5;
    struct {
        void * __that;
        ...
        void (* send_tm_1_4_SID_not_valid)(const __termina_event_t * const __ev, void * const __this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t SID, __status_int32_t * const status);
