...
typedef struct {
    ...
    struct {
        ...
        void (* send_tm_1_4_PMONID_invalid)(const __termina_event_t * const __ev, void * const __this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t PMONID, __status_int32_t * const status);
        void (* send_tm_1_4_PMON_definition_invalid)(const __termina_event_t * const __ev, void * const __this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t PMONID, __status_int32_t * const status);
        void (* send_tm_1_4_PMON_enabled)(const __termina_event_t * const __ev, void * const __this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t PMONID, __status_int32_t * const status);
        void (* send_tm_1_4_PMON_undefined)(const __termina_event_t * const __ev, void * const __this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t PMONID, __status_int32_t * const status);
