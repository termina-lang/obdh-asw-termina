...
typedef struct {
    ...
    struct {
        void * _that;
        void (* write_led)(const termina__event_t * const termina__ev, void * const termina__this, const uint8_t led, const uint8_t value, Status__i32 * const status);
    } gpio_driver;
    struct {
        void * _that;
        ...
        void (* send_tm_1_4_device_address_not_valid)(const termina__event_t * const termina__ev, void * const termina__this, const uint16_t tc_packet_id, const uint16_t tc_packet_seq_ctrl, const uint32_t device_address, Status__i32 * const status);
        ...
        void (* send_tm_1_8_device_command_exec_error)(const termina__event_t * const termina__ev, void * const termina__this, const uint16_t tc_packet_id, const uint16_t tc_packet_seq_ctrl, const uint32_t on_off_command, Status__i32 * const status);
