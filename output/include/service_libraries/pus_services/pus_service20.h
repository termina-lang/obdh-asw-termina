#ifndef SERVICE_LIBRARIES__PUS_SERVICES__PUS_SERVICE20_H__
#define SERVICE_LIBRARIES__PUS_SERVICES__PUS_SERVICE20_H__
...
typedef struct {
    ...
    struct {
        ...
        void (* send_tm_1_4_PID_read_only_via_TC)(const termina__event_t * const termina__ev, void * const termina__this, const uint16_t tc_packet_id, const uint16_t tc_packet_seq_ctrl, const uint16_t PID, Status__i32 * const status);
