...
typedef struct {
    ...
    struct {
        ...
        void (* send_tm_1_4_PID_stats_undefined)(const termina__event_t * const termina__ev, void * const termina__this, const uint16_t tc_packet_id, const uint16_t tc_packet_seq_ctrl, const uint16_t PID, Status__i32 * const status);
        ...
        void (* send_tm_1_8_not_free_stats_config)(const termina__event_t * const termina__ev, void * const termina__this, const uint16_t tc_packet_id, const uint16_t tc_packet_seq_ctrl, const uint16_t PID, Status__i32 * const status);
