...
typedef struct {
    ...
    struct {
        ...
        void (* send_tm_1_4_ev_action_enabled)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t event_ID, Status__i32 * const status);
        void (* send_tm_1_4_ev_action_rejected)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t event_ID, Status__i32 * const status);
        void (* send_tm_1_4_ev_action_undefined)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t event_ID, Status__i32 * const status);
        ...
        void (* send_tm_1_8_max_ev_actions_defined)(const termina__event_t * const termina__ev, void * const termina__this, uint16_t tc_packet_id, uint16_t tc_packet_seq_ctrl, uint16_t evID, Status__i32 * const status);
