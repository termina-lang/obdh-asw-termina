...
typedef struct {
    void * __that;
    void (* PUS_prio_exec_tc)(void * const, TCHandler * const,
...
typedef struct {
    ...
    struct {
        void * __that;
        void (* notify_tm_1_1)(const __termina_event_t * const, void * const,
                               uint16_t, uint16_t, uint8_t,
                               __status_int32_t * const);
        void (* send_tm_1_2)(const __termina_event_t * const, void * const,
                             const TCStatus * const, const TCHandler * const,
                             __status_int32_t * const);
