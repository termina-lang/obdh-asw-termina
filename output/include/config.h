...
#define __uart_handler__handler_id 1
...
#define __tc_message_queue__channel_msg_queue_id 4
#define __hkfdir_message_queue__channel_msg_queue_id 5
#define __bkg_message_queue__channel_msg_queue_id 6
#define __action_tc_message_queue__channel_msg_queue_id 7
