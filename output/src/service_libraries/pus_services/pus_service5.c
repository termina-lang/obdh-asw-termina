...
__status_int32_t PUSService5__exec5_5TC(const __termina_event_t * const __ev,
    ...
    if (index > 4U) {
        ...
        self->pus_service_1.send_tm_1_4_EvID_not_valid(__ev,
                                                       self->pus_service_1.__that,
                                                       self->exec_tc_req_status_update.packet_id,
                                                       self->exec_tc_req_status_update.packet_seq_ctrl,
...
void PUSService5__exec_tc(const __termina_event_t * const __ev,
    ...
    } else
    {
        ...
        #line 294 "src/service_libraries/pus_services/pus_service5.fin"
...
void PUSService5__send_tm_5_2(const __termina_event_t * const __ev,
    ...
    if (tm_handler.__variant == Some) {
        ...
        #line 187 "src/service_libraries/pus_services/pus_service5.fin"
        ...
        *status = append_u16_appdata_field((TMHandler *)b_tm_handler.data,
        ...
        if ((*status).__variant == Success) {
            ...
            close_tm((TMHandler *)b_tm_handler.data, 5U, 2U, tm_count,
                     current_obt);
...
void PUSService5__send_tm_5_x(const __termina_event_t * const __ev,
    ...
    if (tm_handler.__variant == Some) {
        ...
        #line 225 "src/service_libraries/pus_services/pus_service5.fin"
        __termina_box_t b_tm_handler = tm_handler.Some.__0;
        ...
        if (fault_info.__variant == FaultInfo__ParamOutOfLimit) {
            ...
            #line 235 "src/service_libraries/pus_services/pus_service5.fin"
            ...
            *status = build_tm_5_x_param_out_of_limit((TMHandler *)b_tm_handler.data,
                                                      tm_count,
        ...
        if (fault_info.__variant == FaultInfo__ParamFaultValue) {
            ...
            *status = build_tm_5_x_param_check_value_fail((TMHandler *)b_tm_handler.data,
                                                          tm_count,
                                                          fault_value_info,
                                                          evID, current_obt);
