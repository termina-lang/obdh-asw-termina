...
static __status_int32_t CPUSService9__exec9_129TC(const __termina_event_t * const __ev, CPUSService9 * const self);
...
static __status_int32_t CPUSService9__exec9_129TC(const __termina_event_t * const __ev, CPUSService9 * const self) {
    ...
    if (status.__variant == Success) {
        ...
        self->obt_manager.set_obt(__ev, self->obt_manager.__that, self->exec_tc_req_status_update.next_OBT);
...
void CPUSService9__exec_tc(const __termina_event_t * const __ev, void * const __this, TCHandler * const tc_handler, __status_int32_t * const action_status) {
    ...
    CPUSService9 * self = (CPUSService9 *)__this;
    ...
    __status_int32_t status = tc_handler_get_u32_appdata_field(tc_handler, &self->exec_tc_req_status_update.next_OBT.seconds);
    ...
    if (status.__variant == Success) {
        ...
        if (subtype == 129U) {
            ...
            status = CPUSService9__exec9_129TC(__ev, self);
