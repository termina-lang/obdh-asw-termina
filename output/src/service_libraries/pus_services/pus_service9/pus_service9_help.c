...
TimeVal substract_TimeVal(TimeVal timeval1, TimeVal timeval2) {
    ...
    if (result.tv_usec < 0U) {
        ...
        #line 24 "src/service_libraries/pus_services/pus_service9/pus_service9_help.fin"
        result.tv_usec = result.tv_usec + 1000000U;

    }

    #line 26 "src/service_libraries/pus_services/pus_service9/pus_service9_help.fin"
    return result;
