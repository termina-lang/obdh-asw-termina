...
_Bool is_crc_valid(const TCDescriptor * const tc_descriptor) {
    ...
    #line 88 "src/service_libraries/pus_services/pus_service1/internal.fin"
    _Bool is_valid = cal_crc_value == packet_error_ctrl;

    #line 90 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return is_valid;
...
_Bool is_apid_valid(const TCDescriptor * const tc_descriptor) {
    ...
    #line 104 "src/service_libraries/pus_services/pus_service1/internal.fin"
    _Bool is_valid = epd_apid == tc_apid;

    #line 106 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return is_valid;
...
_Bool is_sourceID_valid(const TCDescriptor * const tc_descriptor) {
    ...
    #line 121 "src/service_libraries/pus_services/pus_service1/internal.fin"
    _Bool is_valid = System_SourceID == sourceID;

    #line 123 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return is_valid;
...
_Bool is_tc_ack_accept_enabled(uint8_t flags_ack) {
    ...
    #line 136 "src/service_libraries/pus_services/pus_service1/internal.fin"
    if ((uint8_t)(flags_ack & ACCEPT_ACK_ENABLED_MASK) != 0U) {
        
        #line 137 "src/service_libraries/pus_services/pus_service1/internal.fin"
        ack_enabled = 1;

    }

    #line 139 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return ack_enabled;
...
_Bool is_tc_ack_start_exec_enabled(uint8_t flags_ack) {
    ...
    #line 154 "src/service_libraries/pus_services/pus_service1/internal.fin"
    if ((uint8_t)(flags_ack & EXEC_START_ACK_ENABLED_MASK) != 0U) {
        
        #line 155 "src/service_libraries/pus_services/pus_service1/internal.fin"
        ack_enabled = 1;

    }

    #line 157 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return ack_enabled;
...
_Bool is_tc_ack_progress_exec_enabled(uint8_t flags_ack) {
    ...
    #line 171 "src/service_libraries/pus_services/pus_service1/internal.fin"
    if ((uint8_t)(flags_ack & EXEC_PROGRESS_ACK_ENABLED_MASK) != 0U) {
        
        #line 172 "src/service_libraries/pus_services/pus_service1/internal.fin"
        ack_enabled = 1;

    }

    #line 174 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return ack_enabled;
...
_Bool is_tc_ack_completion_exec_enabled(uint8_t flags_ack) {
    ...
    #line 188 "src/service_libraries/pus_services/pus_service1/internal.fin"
    if ((uint8_t)(flags_ack & EXEC_COMPLETION_ACK_ENABLED_MASK) != 0U) {
        
        #line 189 "src/service_libraries/pus_services/pus_service1/internal.fin"
        ack_enabled = 1;

    }

    #line 191 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return ack_enabled;
...
uint8_t get_failure_subtype(TCVerifyStage verify_stage) {
    ...
    if (verify_stage.__variant == TCVerifyStage__ExecStart) {
        ...
        #line 210 "src/service_libraries/pus_services/pus_service1/internal.fin"
        subtype = 4U;
    ...
    if (verify_stage.__variant == TCVerifyStage__Progress) {
        ...
        #line 213 "src/service_libraries/pus_services/pus_service1/internal.fin"
        subtype = 6U;
    ...
    #line 220 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return subtype;
...
__status_int32_t build_tm_1_X_no_failure_data(TMHandler * const p_tm_handler,
    ...
    if (status.__variant == Success) {
        ...
        #line 251 "src/service_libraries/pus_services/pus_service1/internal.fin"
        close_tm(p_tm_handler, 1U, subtype, tm_seq_counter, current_obt);

    }

    #line 254 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return status;
...
__status_int32_t build_tm_1_X_u8_failure_data(TMHandler * const p_tm_handler,
    ...
    if (status.__variant == Success) {
        ...
        #line 280 "src/service_libraries/pus_services/pus_service1/internal.fin"
        close_tm(p_tm_handler, 1U, subtype, tm_seq_counter, current_obt);

    }

    #line 283 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return status;
...
__status_int32_t build_tm_1_X_u16_failure_data(TMHandler * const p_tm_handler,
    ...
    if (status.__variant == Success) {
        ...
        #line 303 "src/service_libraries/pus_services/pus_service1/internal.fin"
        status = append_u8_appdata_field(p_tm_handler, failure_code);
    ...
    if (status.__variant == Success) {
        ...
        #line 306 "src/service_libraries/pus_services/pus_service1/internal.fin"
    ...
    if (status.__variant == Success) {
        ...
        #line 309 "src/service_libraries/pus_services/pus_service1/internal.fin"
        close_tm(p_tm_handler, 1U, subtype, tm_seq_counter, current_obt);

    }

    #line 312 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return status;
...
__status_int32_t build_tm_1_X_u32_failure_data(TMHandler * const p_tm_handler,
    ...
    if (status.__variant == Success) {
        ...
        #line 335 "src/service_libraries/pus_services/pus_service1/internal.fin"
    ...
    if (status.__variant == Success) {
        ...
        #line 338 "src/service_libraries/pus_services/pus_service1/internal.fin"
        close_tm(p_tm_handler, 1U, subtype, tm_seq_counter, current_obt);

    }

    #line 341 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return status;
...
__status_int32_t build_tm_1_X_u8_u32_failure_data(TMHandler * const p_tm_handler,
    ...
    if (status.__variant == Success) {
        ...
        #line 369 "src/service_libraries/pus_services/pus_service1/internal.fin"
    ...
    if (status.__variant == Success) {
        ...
        #line 372 "src/service_libraries/pus_services/pus_service1/internal.fin"
        close_tm(p_tm_handler, 1U, subtype, tm_seq_counter, current_obt);

    }

    #line 375 "src/service_libraries/pus_services/pus_service1/internal.fin"
    return status;
