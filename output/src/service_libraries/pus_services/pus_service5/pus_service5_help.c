...
__status_int32_t build_tm_5_x_param_out_of_limit(TMHandlerT * const p_tm_handler,
    ...
    #line 158 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
    ...
    #line 161 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
        
        #line 162 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
        status = append_u32_appdata_field(p_tm_handler, fault_info.PID_limit);

    }

    #line 164 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
...
__status_int32_t build_tm_5_x_param_check_value_fail(TMHandlerT * const p_tm_handler,
    ...
    #line 175 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    __status_int32_t status;
    #line 175 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    status.__variant = Success;

    #line 177 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    startup_tm(p_tm_handler);

    #line 178 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    status = append_u16_appdata_field(p_tm_handler, ev_ID);

    #line 179 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
        
        #line 180 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
        status = append_u16_appdata_field(p_tm_handler, fault_info.PID);

    }

    #line 182 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
        
        #line 183 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
        status = append_u32_appdata_field(p_tm_handler, fault_info.PID_value);

    }

    #line 185 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
        
        #line 186 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
        status = append_u32_appdata_field(p_tm_handler, fault_info.PID_mask);

    }

    #line 188 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
        
        #line 189 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
        status = append_u32_appdata_field(p_tm_handler,
                                          fault_info.PID_expected_value);

    }

    #line 191 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    if (status.__variant == Success) {
        
        #line 192 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
        uint8_t subtype = (uint8_t)get_Ev_ID_enable_config_index(ev_ID);

        #line 193 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
        close_tm(p_tm_handler, 5U, subtype, tm_seq_counter, current_obt);

    }

    #line 196 "src/service_libraries/pus_services/pus_service5/pus_service5_help.fin"
    return status;
