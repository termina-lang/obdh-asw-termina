...
__status_int32_t build_tm_12_12(TMHandlerT * const p_tm_handler,
    ...
    for (size_t i = 0U; i < 1U && i < (size_t)counter; i = i + 1U) {
        ...
        if (status.__variant == Success) {
            ...
            #line 363 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
        ...
        #line 372 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
        ...
        if (status.__variant == Success) {
            ...
            #line 376 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
            status = append_u32_appdata_field(p_tm_handler,
                                              param_mon_transitions_table[__termina_array__index(1U,
                                                                                                 i)].new_value);
        ...
        if (status.__variant == Success) {
            ...
            #line 379 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
            status = append_u32_appdata_field(p_tm_handler,
                                              param_mon_transitions_table[__termina_array__index(1U,
                                                                                                 i)].limit_value);
        ...
        if (status.__variant == Success) {
            ...
            #line 382 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
        ...
        if (status.__variant == Success) {
            ...
            #line 385 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
        ...
        if (status.__variant == Success) {
            ...
            #line 388 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
            status = append_u32_appdata_field(p_tm_handler,
                                              param_mon_transitions_table[__termina_array__index(1U,
                                                                                                 i)].trans_obt.seconds);
    ...
    #line 391 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
    if (status.__variant == Success) {
        
        #line 392 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
        close_tm(p_tm_handler, 12U, 12U, tm_seq_counter, current_obt);

    }

    #line 396 "src/service_libraries/pus_services/pus_service12/pus_service12_help.fin"
    return status;
