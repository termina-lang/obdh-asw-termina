...
uint16_t get_APID(const uint8_t tc_bytes[256U]) {
    ...
    #line 69 "src/service_libraries/tc_ccsds_pus_format.fin"
...
uint16_t get_packet_length(const uint8_t tc_bytes[256U]) {
    ...
    #line 104 "src/service_libraries/tc_ccsds_pus_format.fin"
...
uint16_t get_packet_seq_ctrl(const uint8_t tc_bytes[256U]) {
    ...
    #line 120 "src/service_libraries/tc_ccsds_pus_format.fin"
...
uint8_t get_type(const uint8_t tc_bytes[256U]) {
    ...
    #line 143 "src/service_libraries/tc_ccsds_pus_format.fin"
    return type;
...
uint8_t get_subtype(const uint8_t tc_bytes[256U]) {
    ...
    #line 155 "src/service_libraries/tc_ccsds_pus_format.fin"
    return subtype;
...
uint16_t get_source_id(const uint8_t tc_bytes[256U]) {
    ...
    #line 168 "src/service_libraries/tc_ccsds_pus_format.fin"
    return sourceID;
...
void tc_get_fields(const uint8_t tc_bytes[256U],
    ...
    #line 205 "src/service_libraries/tc_ccsds_pus_format.fin"
    packet_error_ctrl[1U] = tc_bytes[__termina_array__index(256U,
                                                            (size_t)((*p_tc_packet_header).packet_length + 6U))];

    #line 207 "src/service_libraries/tc_ccsds_pus_format.fin"
    *p_tc_packet_err_ctrl = deserialize_uint16(packet_error_ctrl);

    #line 209 "src/service_libraries/tc_ccsds_pus_format.fin"
    return;
