...
uint16_t ccsds_pus_tm_build_packet_id(uint16_t apid) {
    ...
    #line 40 "src/service_libraries/tm_ccsds_pus_format.fin"
...
uint16_t ccsds_pus_tm_build_packet_seq_ctrl(uint16_t sequence_flags,
    ...
    #line 47 "src/service_libraries/tm_ccsds_pus_format.fin"
...
uint32_t ccsds_pus_tm_build_df_header(uint8_t service_type,
    ...
    #line 54 "src/service_libraries/tm_ccsds_pus_format.fin"
...
uint8_t ccsds_pus_tm_build_df_header_version(uint8_t version) {
    ...
    #line 61 "src/service_libraries/tm_ccsds_pus_format.fin"
...
void ccsds_pus_tm_set_fields(uint8_t tm_bytes[10U],
    ...
    #line 69 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_id, &tm_bytes[0U]);

    #line 72 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_seq_ctrl, &tm_bytes[2U]);

    #line 75 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_length, &tm_bytes[4U]);

    #line 78 "src/service_libraries/tm_ccsds_pus_format.fin"
    tm_bytes[6U] = p_tm_df_header->version;

    #line 81 "src/service_libraries/tm_ccsds_pus_format.fin"
    tm_bytes[7U] = p_tm_df_header->type;

    #line 82 "src/service_libraries/tm_ccsds_pus_format.fin"
    tm_bytes[8U] = p_tm_df_header->subtype;

    #line 83 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_df_header->msg_type_counter, &tm_bytes[9U]);

    #line 84 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_df_header->destinationID, &tm_bytes[11U]);

    #line 85 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint32(p_tm_df_header->obt_secs, &tm_bytes[13U]);

    #line 86 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_df_header->obt_finetime, &tm_bytes[17U]);

    #line 88 "src/service_libraries/tm_ccsds_pus_format.fin"
    return;
