...
void ccsds_pus_tm_set_fields(uint8_t tm_bytes[10U],
    ...
    #line 107 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_seq_ctrl, &tm_bytes[2U]);

    #line 110 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_length, &tm_bytes[4U]);

    #line 113 "src/service_libraries/tm_ccsds_pus_format.fin"
    tm_bytes[6U] = p_tm_df_header->version;

    #line 116 "src/service_libraries/tm_ccsds_pus_format.fin"
    tm_bytes[7U] = p_tm_df_header->type;

    #line 119 "src/service_libraries/tm_ccsds_pus_format.fin"
    tm_bytes[8U] = p_tm_df_header->subtype;

    #line 122 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_df_header->msg_type_counter, &tm_bytes[9U]);

    #line 125 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_df_header->destinationID, &tm_bytes[11U]);

    #line 128 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint32(p_tm_df_header->obt_secs, &tm_bytes[13U]);

    #line 131 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_df_header->obt_finetime, &tm_bytes[17U]);

    #line 133 "src/service_libraries/tm_ccsds_pus_format.fin"
    return;
