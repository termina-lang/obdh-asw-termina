...
uint32_t ccsds_pus_tm_build_df_header(uint8_t service_type,
    ...
    #line 55 "src/service_libraries/tm_ccsds_pus_format.fin"
...
void ccsds_pus_tm_set_fields(uint8_t tm_bytes[10U],
    ...
    #line 70 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_id, &tm_bytes[0U]);

    #line 73 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_seq_ctrl, &tm_bytes[2U]);

    #line 76 "src/service_libraries/tm_ccsds_pus_format.fin"
    serialize_uint16(p_tm_packet_header->packet_length, &tm_bytes[4U]);

    #line 79 "src/service_libraries/tm_ccsds_pus_format.fin"
    ...
    #line 89 "src/service_libraries/tm_ccsds_pus_format.fin"
    return;
