...
void __termina_app__init_globals() {
    ...
    pus_bkg_tc_executor.pus_service_1.send_tm_1_4_error_in_acceptance = CPUSService1__send_tm_1_4_error_in_acceptance;
    pus_bkg_tc_executor.pus_service_20.__that = &pus_service_20;
    pus_bkg_tc_executor.pus_service_20.exec_tc = CPUSService20__exec_tc;
    pus_bkg_tc_executor.pus_service_6.__that = &pus_service_6;
    pus_bkg_tc_executor.pus_service_6.exec_tc = CPUSService6__exec_tc;
