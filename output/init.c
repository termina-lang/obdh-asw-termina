...
void __termina_app__init_globals() {
    ...
    tm_channel.a_tm_handler_pool.__that = &tm_pool;
    tm_channel.a_tm_handler_pool.alloc = __termina_pool__alloc;
    tm_channel.a_tm_handler_pool.free = __termina_pool__free;
    ...
    icu_manager.tc_executor.PUS_prio_exec_tc = CManagerTExecutor__PUS_prio_exec_tc;
    icu_manager.tc_executor.mng_tc_acceptation = CManagerTExecutor__mng_tc_acceptation;
    icu_manager.tc_executor.mng_tc_rejection = CManagerTExecutor__mng_tc_rejection;
    ...
    bkg_tc_executor.a_tc_handler_pool.__that = &tc_pool;
    bkg_tc_executor.a_tc_handler_pool.alloc = __termina_pool__alloc;
    bkg_tc_executor.a_tc_handler_pool.free = __termina_pool__free;
