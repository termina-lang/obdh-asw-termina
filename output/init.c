...
void __termina_app__init_globals() {
    ...
    #line 215 "app/app.fin"
    pus_service_6.exec_tc_req_status.__variant = PSExecTCReqStatus__Init;
    ...
    for (size_t __i0 = 0U;
         ...
         __i0 = __i0 + 1U) {
        #line 23 "src/service_libraries/pus_services/pus_service6/pus_service6_help.fin"
    ...
    pus_service_6.pus_service_9.__that = &pus_service_9;
    #line 214 "app/app.fin"
    pus_service_6.pus_service_9.get_current_obt = PUSService9__get_current_obt;
