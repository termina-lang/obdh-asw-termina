...
void __termina_app__init_globals() {
    ...
    icu_manager.mng_tc_executor.__that = &mng_tc_executor;
    icu_manager.mng_tc_executor.PUS_prio_exec_tc = CManagerTExecutor__PUS_prio_exec_tc;
    icu_manager.mng_tc_executor.mng_tc_acceptation = CManagerTExecutor__mng_tc_acceptation;
    icu_manager.mng_tc_executor.mng_tc_rejection = CManagerTExecutor__mng_tc_rejection;
    icu_manager.tc_handler_pool.__that = &tc_pool;
    icu_manager.tc_handler_pool.alloc = __termina_pool__alloc;
    icu_manager.tc_handler_pool.free = __termina_pool__free;
