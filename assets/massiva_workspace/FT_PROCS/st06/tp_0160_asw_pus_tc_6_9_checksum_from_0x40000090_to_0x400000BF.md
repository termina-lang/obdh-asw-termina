...
| | Check that checksum calculation is executed and TM (6,10) contains expected checksum | | TM(1,1)<br>TM(6,10)<br>TM(1,7) | N = 1, Memory ID = 0, Start Address = 0x90, Length = 48, Checksum = 0x530A |